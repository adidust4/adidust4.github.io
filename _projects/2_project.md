---
layout: page
title: Socially Assistive Robotics for Facilitation of a Support Group
description: 
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/support group.png" title="Example of Robot-Guided Support Group" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
    An example of a robot-guided CBT support group.
</div>

***

Interaction Lab Project Page: <a href='https://uscinteractionlab.web.app/project/facilitation'>https://uscinteractionlab.web.app/project/facilitation</a>
